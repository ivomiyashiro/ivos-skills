...
**If worktree path is under `.worktrees/`, `worktrees/`, or `~/.config/agent/worktrees/`:** The agent created this worktree — we own cleanup.
...
- **Fix:** Only clean up worktrees under `.worktrees/`, `worktrees/`, or `~/.config/agent/worktrees/`
