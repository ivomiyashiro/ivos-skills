...
|-------------------|----------------------|
| `Task tool (subagent-driven-development)` | `@generalist` with the filled `implementer-prompt.md` template |
| `Task tool (subagent-driven-development)` | `@generalist` with the filled `spec-reviewer-prompt.md` template |
| `Task tool (requesting-code-review)` | `@code-reviewer` (bundled agent) or `@generalist` with the filled review prompt |
| `Task tool (subagent-driven-development)` | `@generalist` with the filled `code-quality-reviewer-prompt.md` template |
