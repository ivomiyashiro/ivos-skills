 ...
 * registra handlers SIGTERM/SIGINT para graceful shutdown.
 */
...
const shutdown = async (signal: string) => {
  ...
  try {
    // postgres.js expone .end() via el cliente subyacente.
    // drizzle no expone el cliente directamente; lo cerramos via process exit.
  } catch (err) {
